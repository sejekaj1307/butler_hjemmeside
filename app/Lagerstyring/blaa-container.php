    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <ul class="sec_navbar_ul_dropdown">
                <li><a href="../Lagerstyring/lade.php">Lade lager</a></li>
                <li><a href="../Lagerstyring/blaa-container.php" class="active_site_dropdown">Blå container lager</a>
                </li>
                <li><a href="../Lagerstyring/andet.php">Andet lager</a></li>
            </ul>
        </div>
