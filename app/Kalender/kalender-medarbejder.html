...
<head>
    ...
    <title>Kalender medarbejdere</title>
</head>
...
<body>
    ...
    <div class="navbar_container">
        ...
        <ul class="navbar_ul">
            ...
            <li><a href="../Kalender/kalender-maskiner.html" class="active-main-site">Kalender</a></li>
    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <h2 class="sec-navbar-mobile-header">Medarbejder kalender<div class="arrow_container"><img
                        src="../img/arrow.png" alt="arrow" class="sec_nav_dropdown_arrow"></div>
            </h2>
            <ul class="sec_navbar_ul_dropdown">
                <li><a href="../Kalender/kalender-maskiner.html">Maskiner kalender</a></li>
                <li><a href="../Kalender/kalender-medarbejder.html" class="active_site_dropdown">Medarbejder
                        kalender</a></li>
                <li><a href="../Kalender/kalender-boss.html">Chef kalender</a>
                </li>
            </ul>
        </div>
