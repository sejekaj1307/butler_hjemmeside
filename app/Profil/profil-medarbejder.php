...
<head>
    ...
    <title>Medarbejder profil</title>
</head>
...
<body>
    ...
    <div class="navbar_container">
        ...
        <ul class="navbar_ul">
            <li><a href="../Profil/profil.html" class="active-main-site">Profil</a></li>
    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <ul class="sec_navbar_ul_dropdown">
                <li><a href="../Profil/profil.html">Profil</a>
                <li><a href="../Profil/notifikationer.html">Notifikationer</a>
                <li><a href="../Profil/profil-medarbejder.html" class="active_site_dropdown">Medarbejder profil</a></li>
                </li>
            </ul>
        </div>
