...
<body>
    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <h2 class="sec-navbar-mobile-header">Lager andet<div class="arrow_container"><img src="../img/arrow.png"
                        alt="arrow" class="sec_nav_dropdown_arrow"></div>
            </h2>
            <ul class="sec_navbar_ul_dropdown">
                <li><a href="../Lagerstyring/lade.html">Lade lager</a></li>
                <li><a href="../Lagerstyring/blaa-container.html">Blå container lager</a>
                </li>
                <li><a href="../Lagerstyring/andet.html" class="active_site_dropdown">Andet lager</a></li>
            </ul>
        </div>
