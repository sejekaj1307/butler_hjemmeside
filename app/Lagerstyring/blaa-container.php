...
<body>
    ...
    <div class="navbar_container">
        ...
        <ul class="navbar_ul">
            ...
            <li><a href="../Lagerstyring/lade.html" class="active-main-site">Lager styring</a></li>
        </ul>
    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <h2 class="sec-navbar-mobile-header">Blå container <div class="arrow_container"><img src="../img/arrow.png"
                        alt="arrow" class="sec_nav_dropdown_arrow"></div>
            </h2>
            <ul class="sec_navbar_ul_dropdown">
                <li><a href="../Lagerstyring/lade.html">Lade lager</a></li>
                <li><a href="../Lagerstyring/blaa-container.html" class="active_site_dropdown">Blå container lager</a>
                </li>
                <li><a href="../Lagerstyring/andet.html">Andet lager</a></li>
            </ul>
        </div>
