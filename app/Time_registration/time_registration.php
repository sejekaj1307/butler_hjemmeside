...
<body>
    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <h2 class="sec-navbar-mobile-header">Tidsregistrering<div class="arrow_container"><img
                        src="../img/arrow.png" alt="arrow" class="sec_nav_dropdown_arrow"></div>
            </h2>
            <ul class="sec_navbar_ul_dropdown">
                <li><a href="../Time_registration/time_registration.php"
                        class="active_site_dropdown">Tidsregistrering</a></li>
                <li><a href="../Time_registration/internal_case.php">2022 intern sag</a></li>
            </ul>
        </div>
