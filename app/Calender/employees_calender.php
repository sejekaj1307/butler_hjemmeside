...
<head>
    ...
    <title>Calender medarbejdere</title>
</head>
    ...
    <div class="site_container">
        ...
        <div class="sec-navbar-mobile">
            ...
            <ul class="sec_navbar_ul_dropdown">
                ...
                <li><a href="../Calender/employees_calender.php" class="active_site_dropdown">Medarbejder
                        kalender</a></li>
                <li><a href="../Calender/bosses_calender.php">Chef kalender</a>
                </li>
            </ul>
        </div>
